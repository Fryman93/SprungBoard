...
Please list the names of the facilities that do.
   ...
   Q1 Answer: Tennis Court 1, Tennis Court 2, Massage Room 1, 
...
SELECT firstname, surname, concat(firstname," ", surname) as fullname  
FROM Members 
...
f.name as tennis_court
FROM Bookings b 
JOIN Members m ON b.memid = m.memid
JOIN Facilities f ON f.facid = b.facid
WHERE (f.facid = 0 OR f.facid = 1) AND m.firstname != 'GUEST'
